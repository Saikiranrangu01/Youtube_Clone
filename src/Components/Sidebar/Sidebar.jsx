  ...
  return (
    <div className={`sidebar ${sidebar?"": "small-sidebar"}`}>
        <div className="shortcut-links">
            <div className={`side-links ${caFtegory===0?"active":""}`} onClick={()=>setCategory(0)}>
            ...
            <div className={`side-links ${category===10?"active":""}`} onClick={()=>setCategory(10)}>
                <img src={automobiles} alt="" /><p>Music</p>
            </div>

            <div className={`side-links ${category===15?"active":""}`} onClick={()=>setCategory(15)}>
                <img src={sports} alt="" /><p>Pets & Animals</p>
            </div>
            ...
            <div className={`side-links ${category===28?"active":""}`} onClick={()=>setCategory(28)}>
                <img src={tech} alt="" /><p>Science & Technology</p>
            </div>

            <div className={`side-links ${category===17?"active":""}`} onClick={()=>setCategory(17)}>
                <img src={music} alt="" /><p>Sports</p>
            </div>
            ...
            <div className={`side-links ${category===30?"active":""}`} onClick={()=>setCategory(30)}>
                <img src={news} alt="" /><p>Movies</p>
            </div>

            <div className={`side-links ${category===43?"active":""}`} onClick={()=>setCategory(43)}>
